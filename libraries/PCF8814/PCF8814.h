...
#define LCD_MIN_DELAY	0 // *****!!!!! Минимальная задержка, при которой работает LCD-контроллер
...
#else
	#define SPI_CLOCK_DIV	0x05 // Делитель SPI, определяет скорость. Значения [0-6] = Fosc/[4,16,64,128,2,8,32]
